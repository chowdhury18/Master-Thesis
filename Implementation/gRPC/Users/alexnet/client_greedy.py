...
spec = importlib.util.spec_from_file_location("module.name", "/home/arnab/Desktop/DNN/gRPC/Users/alexnet/alexnet.py")
...
logging.basicConfig(filename= "/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_alexnet_cpu_greedy_part.log" , filemode="a", level= logging.INFO, format=custom_logging_format)
...
def received_message(msg, current_layer):
    ...
    try:
        ...
        if message[0] == "conv":
            ...
            sent_data = sent_goodput[current_layer] # goodput
            received_goodput[current_layer] = img_part.element_size() * img_part.nelement() # goodput
            received_data = received_goodput[current_layer] # goodput
...
def reset():
    ...
    sent_goodput = np.zeros(6)
    received_goodput = np.zeros(6)

def set_value(current_layer, trans_time, transmission_data, computation_time):
    global transmission_latency, computation_latency, transmission_data_size

    transmission_latency[current_layer] += trans_time
...
def main():
    ...
    try:
        ...
        csv_file = open('/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_alexnet_cpu_greedy_part.csv','a')
        ...
        final_out = None
        num_layers = 6 # 5 conv layers and 1 sequential fc layers
        ...
        for img,level in loader:
            ...
            for layer in range(num_layers):
                ...
                if current_layer < 5:
                    ...
                    print(f"conv transmission_time: {transmission_time}")
                    transmission_time = 0
                else:
                    ...
                    final_out = img_part
                    total_transmission_time += transmission_time
                    print(f"fc transmission_time: {transmission_time}")

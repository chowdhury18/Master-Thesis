...
logging.basicConfig(filename= "/home/arnab/Desktop/DNN/gRPC/logs/gRPC_user_alexnet_gpu.log" , filemode="a", level= logging.INFO, format=custom_logging_format)
...
def main():
    ...
    try:
        ...
        #writer.writeheader()
        csv_file1 = open('/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_alexnet_gpu_node_1.csv','a')
        csv_file2 = open('/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_alexnet_gpu_node_2.csv','a')

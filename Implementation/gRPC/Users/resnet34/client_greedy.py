...
logging.basicConfig(filename= "/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_resnet34_cpu_greedy_part.log" , filemode="a", level= logging.INFO, format=custom_logging_format)
...
def reset():
    ...
    sent_goodput = np.zeros(18)
    received_goodput = np.zeros(18)
...
def main():
    ...
    try:
        ...
        csv_file = open('/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_resnet34_cpu_greedy_part.csv','a')
        ...
        final_out = None
        num_layers = 18 # 17 conv layers and 1 sequential fc layers

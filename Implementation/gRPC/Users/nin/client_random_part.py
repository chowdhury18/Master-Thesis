...
logging.basicConfig(filename= "/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_nin_cpu_random_part.log" , filemode="a", level= logging.INFO, format=custom_logging_format)
...
def main():
    ...
    try:
        ...
        csv_file = open('/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_nin_cpu_random_part.csv','a')

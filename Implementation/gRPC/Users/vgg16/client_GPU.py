...
logging.basicConfig(filename= "/home/arnab/Desktop/DNN/gRPC/logs/gRPC_user_vgg16_gpu_msg_size.log" , filemode="a", level= logging.INFO, format=custom_logging_format)
...
def main():
    ...
    try:
        ...
        csv_file1 = open('/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_vgg16_gpu_node_1.csv','a')
        csv_file2 = open('/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_vgg16_gpu_node_2.csv','a')

...
logging.basicConfig(filename= "/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_vgg16_cpu_greedy_part.log" , filemode="a", level= logging.INFO, format=custom_logging_format)
...
def reset():
    ...
    sent_goodput = np.zeros(19)
    received_goodput = np.zeros(19)

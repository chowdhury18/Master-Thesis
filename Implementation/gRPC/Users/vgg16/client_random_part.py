...
logging.basicConfig(filename= "/home/arnab/Desktop/DNN/gRPC/logs/gRPC_time_state_vgg16_cpu_random_part.log" , filemode="a", level= logging.INFO, format=custom_logging_format)
